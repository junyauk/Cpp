...
namespace moduleexample::moduleb
{
	...
	export constexpr int kModuleBValue = 200;
	...
	export int legacy_add_viaModuleB(int a, int b);

	// This combine with Legacy's constant
	export constexpr int kModuleBCombinedValue =
		kModuleBValue + kLegacyValue + 1;
}
