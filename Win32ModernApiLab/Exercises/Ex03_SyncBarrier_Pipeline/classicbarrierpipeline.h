...
namespace Ex03_SyncBarrier_Pipeline
{
	...
	public:
		...
		ClassicBarrierPipeline(const ClassicBarrierPipeline&) = delete;
		ClassicBarrierPipeline(ClassicBarrierPipeline&&) = delete;
		ClassicBarrierPipeline& operator=(const ClassicBarrierPipeline&) = delete;
		ClassicBarrierPipeline& operator=(ClassicBarrierPipeline&&) = delete;
