...
namespace Ex03_OrderBookProcessor
{
	...
	class ModernOrderBook : public IOrderBook<T>
	{
	public:
		ModernOrderBook(uint32_t symbolId) : m_symbolId(symbolId) {}
		~ModernOrderBook() {}

		ModernOrderBook() = delete;
		ModernOrderBook(const ModernOrderBook&) = delete;
		ModernOrderBook(ModernOrderBook&&) = delete;
		ModernOrderBook& operator=(const ModernOrderBook&) = delete;
		ModernOrderBook& operator=(ModernOrderBook&&) = delete;
